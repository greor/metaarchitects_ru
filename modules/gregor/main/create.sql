...
INSERT INTO `sites` ( `url`, `name`, `active` ) VALUES ( 'http://lebedinaya-nezhnost.loc', 'Лебединая нежность', 1 );
INSERT INTO `admins` (`email`, `username`, `password`, `active`, `role`) VALUES ('gregor.zoonoid@gmail.com', 'superadmin', '$2a$12$Uc5UVUwpOMtMGUHOAOcRS.ut0bYqxVss.SmpUjrWj05iextmv5CQW', 1, 'super');
